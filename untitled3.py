...
class Parent():
    ...
    def Software_Engineer(it_name):
        it_company_list = ["I Code", "Web Ascess", "Dotcom Services", "ATOS"]
    ...
    def Chemical_Engineer(chemical_name):
        company_list = ["Amul", "Cadbury", "Filpkart"]
...
btn_it = Button(root, text = "show the IT comapny Alloted", command = child2_obj.get_it)
btn_it.place(relx = 0.5, rely = 0.4, anchor = CENTER)

btn_chemical = Button(root, text = "Show the Chemical Alloted", command = child3_obj.get_chemical)
